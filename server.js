...
app.use('/reviews', proxy({target: 'http://18.188.6.98:8000'}))
...
//   request(
//     `http://54.67.22.134/${req.params.Id}/amenities`,
//     (err, response, body) => {
//       if (err) {
//         console.log(err);
//       }
...
//   request(
//     `http://13.56.234.247/${req.params.Id}/reviews?limit=${
//       req.query.limit
...
//   request(
//     `http://18.217.250.139/photos/${req.params.Id}`,
//     (err, response, body) => {
//       if (err) {
//         console.log(err);
//       }
...
//   request(
//     `http://18.212.20.57/homes/${req.params.Id}/suggestions`,
//     (err, response, body) => {
//       if (err) {
//         console.log(err);
//       }
...
//   request(
//     `http://18.191.46.241/availabilities/${req.params.Id}`,
//     (err, response, body) => {
//       if (err) {
//         console.log(err);
//       }
